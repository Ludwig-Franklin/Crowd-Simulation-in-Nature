...
public class SimulationConfig
{
    ...
    public float visualPathFollowStrength = 425f;  // Vision-based method
    public float VisualDistanceFactor_sigma = 12f;
    ...
    public int visionArcCount = 5;
    public int firstArcPointCount = 10;
    public int lastArcPointCount = 20;
